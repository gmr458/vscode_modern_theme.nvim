...
function M.set(config)
    ...
    vim.api.nvim_set_hl(0, "Cursor", { bg = colors.fg, fg = config.v2 and colors.bg_v2 or colors.bg })
    vim.api.nvim_set_hl(0, "CursorIM", { bg = colors.fg, fg = config.v2 and colors.bg_v2 or colors.bg })
    ...
    vim.api.nvim_set_hl(0, "FloatBorder", { bg = config.v2 and colors.bg_v2 or colors.bg, fg = colors.bg_11 })
    -- vim.api.nvim_set_hl(0, "FloatTitle", {})
    -- vim.api.nvim_set_hl(0, "IncSearch", {})
    vim.api.nvim_set_hl(0, "lCursor", { bg = colors.fg, fg = config.v2 and colors.bg_v2 or colors.bg })
    vim.api.nvim_set_hl(0, "LineNr", { bg = config.v2 and colors.bg_v2 or colors.bg, fg = colors.fg_03 })
    ...
    vim.api.nvim_set_hl(0, "Normal", { bg = config.v2 and colors.bg_v2 or colors.bg, fg = colors.fg })
    ...
    vim.api.nvim_set_hl(0, "Title", { fg = colors.fg_09 })
    ...
    vim.api.nvim_set_hl(0, "WinBar", { fg = colors.fg_06 })
    ...
    vim.api.nvim_set_hl(0, "Pmenu", { bg = colors.bg_04, fg = colors.fg_08 })
    -- vim.api.nvim_set_hl(0, "PmenuExtra", {})
    -- vim.api.nvim_set_hl(0, "PmenuExtraSel", {})
    -- vim.api.nvim_set_hl(0, "PmenuKind", {})
    -- vim.api.nvim_set_hl(0, "PmenuKindSel", {})
    vim.api.nvim_set_hl(0, "PmenuSbar", { bg = colors.bg_04 })
    vim.api.nvim_set_hl(0, "PmenuSel", { bg = colors.blue_01, fg = colors.fg_09 })
    ...
    vim.api.nvim_set_hl(0, "@keyword.export.javascriptreact", { fg = colors.purple_02 })
    vim.api.nvim_set_hl(0, "@keyword.export.typescriptreact", { fg = colors.purple_02 })
    ...
    vim.api.nvim_set_hl(0, "@namespace.go", { fg = colors.fg })
    vim.api.nvim_set_hl(0, "@number", { fg = colors.green_09 })
    vim.api.nvim_set_hl(0, "@operator", { fg = colors.fg })
    ...
    vim.api.nvim_set_hl(0, "@tag.javascript", { fg = colors.blue_10 })
    vim.api.nvim_set_hl(0, "@tag.attribute", { link = "@variable" })
    vim.api.nvim_set_hl(0, "@tag.delimiter", { fg = colors.fg_02 })
    ...
    vim.api.nvim_set_hl(0, "TreesitterContext", { bg = colors.bg_04 })
    -- vim.api.nvim_set_hl(0, "TreesitterContextBottom", {})
    vim.api.nvim_set_hl(0, "TreesitterContextLineNumber", { bg = colors.bg_04 })
    ...
    -- ibhagwan/fzf-lua
    vim.api.nvim_set_hl(0, "FzfLuaBorder", { fg = colors.fg_01 })
    ...
    vim.api.nvim_set_hl(0, "TelescopeSelection", { bg = colors.blue_01, fg = colors.fg_09 })
    ...
    -- Diagnostics LSP
    vim.api.nvim_set_hl(0, "DiagnosticBorder", { bg = config.v2 and colors.bg_v2 or colors.bg, fg = colors.fg_01 })
    ...
    -- LspInfo
    vim.api.nvim_set_hl(0, "LspInfoBorder", { fg = colors.fg_01 })
    ...
    vim.api.nvim_set_hl(0, "NavicText", { fg = colors.fg_06 })
    vim.api.nvim_set_hl(0, "NavicSeparator", { fg = colors.fg_06 })
    ...
    vim.api.nvim_set_hl(0, "TroubleCount", { bg = colors.bg_09, fg = colors.fg_09 })
    -- vim.api.nvim_set_hl(0, "TroubleError", {})
    vim.api.nvim_set_hl(0, "TroubleFile", { fg = colors.fg_08 })
    vim.api.nvim_set_hl(0, "TroubleFoldIcon", { fg = colors.fg_07 })
    -- vim.api.nvim_set_hl(0, "TroubleHint", {})
    -- vim.api.nvim_set_hl(0, "TroubleIndent", {})
    -- vim.api.nvim_set_hl(0, "TroubleInformation", {})
    vim.api.nvim_set_hl(0, "TroubleLocation", { fg = colors.fg_05 })
    ...
    vim.api.nvim_set_hl(0, "TroubleSource", { fg = colors.fg_05 })
    ...
    vim.api.nvim_set_hl(0, "CmpDocBorder", { bg = config.v2 and colors.bg_v2 or colors.bg, fg = colors.bg_11 })
    ...
    vim.api.nvim_set_hl(0, "CmpItemKind", { fg = colors.fg_08 })
    ...
    vim.api.nvim_set_hl(0, "CmpItemKindConstant", { fg = colors.fg_08 })
    ...
    vim.api.nvim_set_hl(0, "CmpItemKindEvent", { fg = colors.fg_08 })
    ...
    vim.api.nvim_set_hl(0, "CmpItemKindFile", { fg = colors.fg_08 })
    ...
    vim.api.nvim_set_hl(0, "CmpItemKindKeyword", { fg = colors.fg_08 })
    ...
    vim.api.nvim_set_hl(0, "CmpItemKindModule", { fg = colors.fg_08 })
    -- vim.api.nvim_set_hl(0, "CmpItemKindModuleDefault", {})
    vim.api.nvim_set_hl(0, "CmpItemKindOperator", { fg = colors.fg_08 })
    ...
    vim.api.nvim_set_hl(0, "CmpItemKindReference", { fg = colors.fg_08 })
    -- vim.api.nvim_set_hl(0, "CmpItemKindReferenceDefault", {})
    vim.api.nvim_set_hl(0, "CmpItemKindSnippet", { fg = colors.fg_08 })
    -- vim.api.nvim_set_hl(0, "CmpItemKindSnippetDefault", {})
    vim.api.nvim_set_hl(0, "CmpItemKindSnippetFunction", { fg = colors.fg_08 })
    vim.api.nvim_set_hl(0, "CmpItemKindSnippetStruct", { fg = colors.fg_08 })
    vim.api.nvim_set_hl(0, "CmpItemKindStruct", { fg = colors.fg_08 })
    -- vim.api.nvim_set_hl(0, "CmpItemKindStructDefault", {})
    vim.api.nvim_set_hl(0, "CmpItemKindText", { fg = colors.fg_08 })
    -- vim.api.nvim_set_hl(0, "CmpItemKindTextDefault", {})
    vim.api.nvim_set_hl(0, "CmpItemKindTypeParameter", { fg = colors.fg_08 })
    -- vim.api.nvim_set_hl(0, "CmpItemKindTypeParameterDefault", {})
    vim.api.nvim_set_hl(0, "CmpItemKindUnit", { fg = colors.fg_08 })
    ...
    vim.api.nvim_set_hl(0, "CmpMenuBorder", { bg = config.v2 and colors.bg_v2 or colors.bg, fg = colors.bg_11 })
    vim.api.nvim_set_hl(0, "CmpMenuSel", { bg = colors.blue_01, fg = colors.fg_09 })
    ...
    vim.api.nvim_set_hl(0, "NvimTreeCursorLine", { bg = colors.bg_05 })
    ...
    vim.api.nvim_set_hl(0, "NvimTreeRootFolder", { fg = colors.fg_08 })
    ...
    -- vim.api.nvim_set_hl(0, "ToggleTerm1NormalFloat", { bg = colors.menu_background })
    -- vim.apf.nvim_set_hl(0, "ToggleTerm1FloatBorder", { bg = colors.menu_background, fg = colors.menu_background })
    ...
    vim.api.nvim_set_hl(0, "AlphaShorcut", { fg = colors.fg_03 })
    ...
    vim.api.nvim_set_hl(0, "LazyComment", { fg = colors.fg_03 })
    ...
    vim.api.nvim_set_hl(0, "LazyNormal", { bg = colors.bg_01 })
    -- vim.api.nvim_set_hl(0, "LazyProgressDone", {})
    -- vim.api.nvim_set_hl(0, "LazyProgressTodo", {})
    vim.api.nvim_set_hl(0, "LazyProp", { bg = colors.bg_01 })
